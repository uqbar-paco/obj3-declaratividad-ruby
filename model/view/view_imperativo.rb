...
include AlumnoView
  ...
  def view_html
    result = "<html><body>\n<h1>Alumno</h1>\n"
    result = result + "<table>\n"
    result = result + "<tr><td style='padding-right:20px;'>Legajo</td><td>#{@alumno.legajo}</td></tr>\n"
    result = result + "<tr><td style='padding-right:20px;'>Nombre</td><td>#{@alumno.nombre}</td></tr>\n"
    result = result + "<tr><td style='padding-right:20px;'>Cant. materias aprobadas</td><td>#{@alumno.cantidad_materias_aprobadas}</td></tr>\n"
